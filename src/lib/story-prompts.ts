...
export const STORY_PROMPT_IMAGES: StoryPromptImage[] = [
  {
    id: "forest-adventure",
    src: "/story-prompts/forest-adventure.webp",
  ...
  {
    id: "ocean-discovery",
    src: "/story-prompts/ocean-discovery.webp",
  ...
  {
    id: "space-journey",
    src: "/story-prompts/space-journey.webp",
  ...
  {
    id: "magical-garden",
    src: "/story-prompts/magical-garden.webp",
  ...
  {
    id: "city-builders",
    src: "/story-prompts/city-builders.webp",
  ...
  {
    id: "animal-friends",
    src: "/story-prompts/animal-friends.webp",
  ...
  {
    id: "rainy-day",
    src: "/story-prompts/rainy-day.webp",
  ...
  },
  {
    ...
    src: "/story-prompts/mountain-explorer.webp",
  ...
  {
    id: "treasure-map",
    src: "/story-prompts/treasure-map.webp",
