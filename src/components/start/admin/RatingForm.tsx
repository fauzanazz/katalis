...
import { submitRatingFn } from "@/lib/server/admin-reliability";
...
export function RatingForm({
  ...
  function handleSubmit(event: React.FormEvent) {
    ...
    startTransition(async () => {
      const res = await submitRatingFn({
        data: {
          discoveryId,
          humanInterestKeys: [...humanInterestKeys] as never,
          humanTagCategories: [...humanTagCategories] as never,
