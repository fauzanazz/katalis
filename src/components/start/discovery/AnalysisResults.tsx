  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="text-center">
        <h2 className="type-h2">{m.discover_analysis_resultsTitle()}</h2>
        <p className="mt-2 text-muted-foreground">{m.discover_analysis_resultsSubtitle()}</p>
      </div>
        ...
        {results.talents.map((talent, index) => {
          ...
          return (
            <div
              ...
              role="article"
              aria-label={m.discover_analysis_talentCardLabel({ name: talent.name })}
            >
              ...
              <div
                ...
                aria-valuemin={0}
                aria-valuemax={100}
                aria-label={m.discover_analysis_confidenceLabel({
                  name: talent.name,
                  percent: pct,
                })}
              >
